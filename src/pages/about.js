        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            >
              ...
              <p className="font-medium">{aboutData.bio[0]}</p>

              <p className="font-medium my-4">{aboutData.bio[1]}</p>

              <p className="my-6 font-medium">{aboutData.bio[2]}</p>
            </div>

            <div
              className="col-span-3 relative h-max rounded-2xl border-2 border-soild border-dark dark:border-light bg-light dark:bg-dark p-8
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <div className="flex flex-col items-end justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimateNumber value={aboutData.satisfiedClients} />+
                </span>
              ...
              <div className="flex flex-col items-end justify-center xl:items-center">
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimateNumber value={aboutData.projectsCompleted} />+
                </span>
              ...
              <div
                className={`flex flex-col items-end justify-center xl:items-center ${
                  aboutData.yearsOfExperience === 0 ? "hidden" : "flex"
                }`}
              >
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
                  <AnimateNumber value={aboutData.yearsOfExperience} />+
                </span>
